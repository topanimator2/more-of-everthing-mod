...
public class SteelingotItem extends MoreEverythingModElements.ModElement {
	@ObjectHolder("more_everything:steelingot")
	public static final Item block = null;
	public SteelingotItem(MoreEverythingModElements instance) {
		super(instance, 5);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("its a steel ingot"));
		}
	}
}
