...
public class PowercablestraightBlock extends MoreEverythingModElements.ModElement {
	@ObjectHolder("more_everything:powercablestraight")
	public static final Block block = null;
	@ObjectHolder("more_everything:powercablestraight")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public PowercablestraightBlock(MoreEverythingModElements instance) {
		super(instance, 10);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("powercablestraight"));
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("powercablestraight");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("powercablestraight");
		}
		...
		private final EnergyStorage energyStorage = new EnergyStorage(200, 200, 200, 10) {
			@Override
