...
public class Powercable3Block extends MoreEverythingModElements.ModElement {
	@ObjectHolder("more_everything:powercable_3")
	public static final Block block = null;
	@ObjectHolder("more_everything:powercable_3")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public Powercable3Block(MoreEverythingModElements instance) {
		super(instance, 11);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("powercable_3"));
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("powercable_3");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Powercable 3");
		}
		...
		private final EnergyStorage energyStorage = new EnergyStorage(400, 200, 200, 10) {
			@Override
